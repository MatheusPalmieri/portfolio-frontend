import { IProject, ProjectTypeEnum } from '@/interfaces/project';
...
const projects: IProject[] = [
  {
    ...
    slug: 'project-01',
    type: ProjectTypeEnum.FRONTEND,
    repository: 'https://github.com/MatheusPalmieri',
    website: 'https://www.linkedin.com/in/matheusandrepalmieri/',
  },
  {
    id: '2',
    name: 'Project 02',
  ...
  },
  {
    ...
    link: 'https://develop.matheuspalmieri.vercel.app',
    technologies: ['Mantine', 'Next.Js', 'TypeScript', 'Node'],
    slug: 'project-03',
    type: ProjectTypeEnum.FRONTEND,
    repository: 'https://github.com/MatheusPalmieri',
    website: 'https://www.linkedin.com/in/matheusandrepalmieri/',
...
export async function getProjects(): Promise<{ data: IProject[]; status: number }> {
...
export async function getProjectBySlug(slug: string): Promise<{ data: IProject; status: number }> {
  const project: IProject | undefined = projects.find((project: IProject) => project.slug === slug);

  if (!project) throw { message: 'Projeto não encontrado.', status: 400 };
